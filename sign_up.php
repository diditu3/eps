...
$count = 0;
$error = '';
$user_firstname = $user_lastname = $user_password = $user_email = $user_phone = $wedding_date = '';
            ...
            if ($account_details->save()) {
                ...
                if($account_details->update()) {
                    ...
                    if($accounts->save()) {
                        ...
                        $booking->user_password = $user_password;
...
<head>
    ...
    <title>Free Register - Planner</title>
            ...
            <div class="row justify-content-md-center">
                ...
                <div class="col col-lg-5" style="margin-top: 7%;">
                    ...
                    <form class="bgact" action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post">
                        <h2 class="text-center hero-lead">Sign Up Here</h2>
                        <p class="lead text-center" style="color:white;">START BY FILLING UP THE FORM</p>
                            ...
                            <div class="form-group">
                                <input type="password" aria-describedby="password" class="form-control" name="password" id="password" placeholder="Password">
                            </div>
                            <div class="form-group">
