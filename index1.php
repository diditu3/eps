        ...
        <div class="hero">
            <div class="row justify-content-md-center">
                ...
                <div class="col col-lg-5" style="margin-top: 10%;">
                    ...
                    <h1 class="text-center hero-lead">Plan Your Special Day With Us!</h1>
                    <p class="lead text-center" style="color:white;">Take the Stress Out of Planning</p>
                       <!-- <div class="form-row">
                        ...
                        <div class="text-center mt-3">
                            <p style="font-size: 11px;color:white;">By clicking "Sign Up" you agree to our terms <a
...
<div class="container-fluid custom-container">
    <div class="row">
        <div class="col-lg-12">
            ...
            <hr>
            <h2 class="h2 text-uppercase text-center mb-4">Our Events</h2>
                ...
                <div class="pricing">
                    <ul class="list-group list-unstyled">
                        ...
                        <?php $feature = Features::find_by_feature_all($category_row->id); ?>
                            ...
                            <?php endforeach; ?>
                        <li class="list-group-item font-weight-bold">Price:S.P <?= number_format($category_row->price); ?>
                         </li>
...
<div class="container">
    <div class="row">
        <div class="col-lg-12">
            <h2 class="h2 text-uppercase text-center mb-3">OUR PREVIOUS CLIENTS</h2>
