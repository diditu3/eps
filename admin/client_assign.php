...
<?php $users_profile = Users::find_by_id($_SESSION['id']); ?>
    ...
    <head>
        ...
        <title>Edit User Information - Administrator</title>
        ...
        <div class="row">
            ...
            <div class="col-lg-8 offset-2 pl-3 pb-3 box-shadow mt-4">
                ...
                <form method="post" action="">
                    ...
                    <h4 class="h4 mt-4 pb-2" style="border-bottom: 1px solid #dee2e6!important;">User Information
                    ...
                    <div class="form-group">
                        ...
                        <label for="brideName">Age</label>
                        <input type="text" name="bride" class="form-control" value="<?= $booking_detail ->bride;?>" id="brideName" placeholder="Enter Age">

                    </div>

                    <div class="form-group">

                        <label for="GroomsName">Address</label>
                        <input type="text" name="groom" class="form-control" value="<?= $booking_detail ->groom;?>" id="GroomsName" placeholder="Enter Address">
					...
					<div class="form-row">
                    	...
                    	<div class="col form-group">
	                        <label for="inputcash_advanced">Budget</label>
