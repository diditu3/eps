...
<head>
    ...
    <link rel="stylesheet" href="css/style.css"><!-- nav bar-->
        ...
        <div class="col-md-8 p-0" style="margin-bottom: 20px;"> <!-- border:1px solid rgba(0,0,0,.125) -->
            ...
            <div class="float-left bg-white">
                <h5 class="h5 text-uppercase mb-5 pt-3 pl-3 pr-3">
                    <span class="float-left text-capitalize"><?= $category->wedding_type; ?> </span>
                    <span class="float-right text-capitalize">Price: S.P <?= number_format($category->price); ?></span>
                </h5>
            ...
            <div class="col-md-4" style="margin-bottom: 20px;">
                         ...
                         <!--<h5 class="h5 text-center mb-3 m-0">Planning Starts Here</h5>
...
<a href ="about.php"><button class="btn btn-md btn-danger btn-block" type="submit" name="login"> Book Now </button></a>
