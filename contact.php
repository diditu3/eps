                        ...
                        <div class="col-md-8">
                            <table class="table table-sm" style="font-size: 12px;">
                                <tr>
                                    ...
                                    <td><i class="mdi mdi-deskphone mr-3"></i> 011 6661444</td>
                                </tr>
                                <tr>
                                    <td>Mazzeh</td>
                                    <td><i class="mdi mdi-phone mr-3"></i>+963 993 125 489</td>
                                </tr>
                                <tr>
                                    <td></td>
                                    <td><i class="mdi mdi-email mr-3"></i> Fireworks_Company@gmail.com</td>
                                </tr>
                            </table>
                        </div>
                        <!-- <div class="col-md-4">
