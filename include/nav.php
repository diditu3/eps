...
<nav class="navbar navbar-expand-lg navbar-light fixed-top bg-light">
    <div class="container-fluid">
        <a class="navbar-brand" href="index.php">Fireworks </a>
        ...
        <div class="collapse navbar-collapse" id="navbarNavDropdown">
            <ul class="navbar-nav mr-auto">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="pricing.php">Events</a>
                </li>
                <li class="nav-item">
...
<!--                <a class="btn btn-sm my-2 my-sm-0" href="login.php" data-toggle="modal" data-target="#loginModal">-->
                ...
                <a class="btn btn-sm my-2 my-sm-0" href="proffile.php"><i class="mdi mdi-star-outline" id="review" aria-hidden="true"></i>
                Profile
                </a>
