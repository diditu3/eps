...
<head>
    ...
    <link rel="stylesheet" href="css/bootstrap.min.css"><!--box style -->
    <link rel="stylesheet" href="css/bootstrap-datepicker.css">
    <link rel="stylesheet" href="css/style.css"><!-- background style-->
    <style>
        .alert {
            font-size: 12px;
        }
        ...
        <div class="hero">
            <div class="row justify-content-md-center">
                ...
                <div class="col col-lg-5" style="margin-top: 10%;">
                    ...
                    <h2 class="text-center hero-lead">Planning Starts Here</h2>
                    <p class="lead text-center" style="color:white;">START BY FILLING UP THE FORM</p>
                        ...
                        <!--<div class="form-group">
                            <input type="text" class="form-control" name="user_email" id="user_email" placeholder="Age">
                    
                        </div>
                        <div class="form-group">
                            <input type="text" aria-describedby="phoneHelpBlock" class="form-control" name="user_phone" id="user_phone" placeholder="Address">
                        </div>-->
                        ...
                        <div class="form-row">
                            ...
                            <input type="radio" value="Syriatelcash" > Syriatel Cash
                            <input type="radio" value="Fatora">Fatora
                            <input type="radio" value="Cash"> Cash
                            
                     
                           
                        <div class="text-center mt-3">
                            <p style="font-size: 11px;color:white;">By clicking "Book Now" you agree to our terms <a
